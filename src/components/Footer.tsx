...
const Footer = () => {
  return (
    <footer className="bg-forest-deep text-gold px-6 py-10 md:px-12 md:py-16 font-sans border-t border-gold/10 min-h-screen flex flex-col justify-between" id="contact">
      <div className="max-w-7xl mx-auto w-full flex-1 flex flex-col">
        ...
        {/* Link Grid: Centered Spacing with Minimal Fonts */}
        <div className="flex-1 flex flex-col justify-center py-10">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-x-8 gap-y-10 md:gap-y-0 px-1">
            {footerLinks.map((col) => (
        ...
        {/* Bottom Branding */}
        <div className="pt-8 border-t border-gold/10 text-center flex flex-col items-center gap-3 mt-auto">

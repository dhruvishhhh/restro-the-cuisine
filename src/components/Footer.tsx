...
const Footer = () => {
  return (
    <footer className="relative bg-timber pt-12 md:pt-24 pb-8 md:pb-12 overflow-hidden w-full flex flex-col items-center border-t border-white/5" id="contact">
      {/* Decorative Overlays */}
      ...
      <div className="w-full h-px bg-gradient-to-r from-transparent via-primary/20 to-transparent absolute top-0" />
